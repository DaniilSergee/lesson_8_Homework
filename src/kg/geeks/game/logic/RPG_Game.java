...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Witcher witcher = new Witcher(210, 0, "Red");
        Thor thor = new Thor(210, 15, "Coar");
        Warrior warrior = new Warrior(280, 10, "Hercules");
        Medic doc = new Medic(250, 5, 15, "Nebolit");
        Magic magic = new Magic(270, 20, 5, "Merlin");
        Berserk berserk = new Berserk(260, 15, "Gatz");
        Medic assistant = new Medic(300, 10, 5, "House");
        Hero[] heroes = {witcher, thor, warrior, doc, magic, berserk, assistant};
